      ...
      <div className={`flex flex-col gap-4 rounded-md bg-richblack-700 p-4 text-richblack-5`} >
        ...
        <div className="px-4">
          ...
          <div className="flex flex-col gap-4">
            <button className=" px-2 py-2 bg-yellow-25 rounded-md text-richblack-800 font-semibold"  onClick = {user && course?.studentsEnrolled.includes(user?._id) ? () => navigate("/dashboard/enrolled-courses") : handleBuyCourse} >
