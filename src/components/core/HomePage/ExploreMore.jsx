  ...
  return (
    <div>
        <div className='text-4xl font-semibold text-center my-10'>
            ...
            <p className=' text-center text-richblack-300 text-lg  font-semibold px-1 py-1 mt-1'>
            Learn to Build Anything You can Imagine
        </p>
        </div>


        <div className="hidden lg:flex gap-5 mt-3 mx-auto w-max bg-richblack-800 text-richblack-200 p-1 rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]"> 
